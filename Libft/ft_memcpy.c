...
/*                                                   +#+                      */
/*   Created: 2023/10/06 12:17:34 by dode-boe      #+#    #+#                 */
/*   Updated: 2023/10/27 12:23:50 by dode-boe      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// 	memcpy(str1 + 2, str1, 24);
// 	ft_memcpy(str1_1 + 2, str1_1, 24);
// 	printf("%s\n", str1);
// 	printf("%s\n", str1_1);
